...
const reviews_data = [
  {
    ...
    name: "Liam Smith",
    comment:
      "What's better than indulging in candies and winning big?  Wolf Treasure  is my go-to for the sweetest victories!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Olivia Tremblay",
    comment:
      "Been playing  Wolf Treasure  for weeks now — it's simply captivating! Consistent wins and loads of free spins. Absolutely adore this slot!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Noah MacKenzie",
    comment:
      "This game is a sugar rush of excitement!  Wolf Treasure 's vibrant colors and non-stop action make it an addictive delight.",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Emma Gagnon",
    comment:
      " Wolf Treasure  is a treat for the eyes and the wallet! Loving the constant thrill of tumbling wins and the free spins galore.",
  },
  {
    img: "../../media/photos/comments/comment5.png",
    name: "Lucas Leblanc",
    comment:
      "Can't get enough of the sweet-themed slot!  Wolf Treasure  is my guilty pleasure with its fantastic graphics and big win potential.",
  },
  {
    img: "../../media/photos/comments/comment6.png",
    name: "Ava Dubois",
    comment:
      "This game is like a candy store of winnings!  Wolf Treasure 's free spins never fail to bring in those delicious wins.",
  },
  {
    img: "../../media/photos/comments/comment7.png",
    name: "Ethan Roy",
    comment:
      "Absolutely addicted to  Wolf Treasure ! The thrill of consecutive wins with the tumble feature is unbeatable.",
  },
  {
    img: "../../media/photos/comments/comment8.png",
    name: "Charlotte Lefebvre",
    comment:
      " Wolf Treasure  satisfies my craving for both sweets and wins. It's a fantastic blend of fun and potential big payouts.",
  },
  {
    img: "../../media/photos/comments/comment9.png",
    name: "Benjamin Beaulieu",
    comment:
      "Such a fun game!  Wolf Treasure 's free spins keep me coming back for more, and the visuals are simply delightful.",
  },
  {
    img: "../../media/photos/comments/comment10.png",
    name: "Sophia Caron",
    comment:
      " Wolf Treasure  never disappoints! Love the adrenaline rush when those cascading wins keep rolling in. Highly recommended!",
  },
];
