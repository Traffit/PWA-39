...
const reviews_data = [
  {
    ...
    name: "আরিফ হাসান",
    comment: "Batery Plinko একটি সাহসী অভিজ্ঞতা! সুন্দর গেম এবং মজার বোনাস দিয়ে মজা করা যায়। 5/5!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "মেহরিন আক্তার",
    comment: "Batery Plinko আমার জন্য একটি মনোরম অভিজ্ঞতা! গেমগুলি অবাক করা এবং বোনাসগুলি মজার। 4.5/5!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "সাকিব আহমেদ",
    comment:
      "কানাডায় একটি ক্যাসিনো অনুরক্ত হলে অবশ্যই Batery Plinko একটি অসাধারণ অ্যাপ! গ্রাফিক্স দেখতে সত্যিই সুন্দর এবং গেমপ্লে মনোহারী। 4.5/5!",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "সুমাইয়া ইসলাম",
    comment: "Batery Plinko আমার পছন্দের গেম! গ্রাফিক্স অত্যন্ত সুন্দর এবং গেমপ্লে মজাদার। 5/5!",
  },
  {
    img: "../../media/photos/comments/comment5.png",
    name: "মাহফুজ রহমান",
    comment: "Batery Plinko আমার সবচেয়ে পছন্দের গেম! আমি প্রতিবার এখানে খেলার অভিজ্ঞতা অনুভব করি। 5/5!",
  },
];
